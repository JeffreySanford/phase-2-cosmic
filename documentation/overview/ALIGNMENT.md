...
| Product and UX docs (`FRONTEND_UI`, `PROFESSIONAL_CONSOLE_SPEC`, `frontend/features/*`)               | needs-update | Footer load profile exists and now controls runtime generator load through a backend API; documentation should reflect the new SSE telemetry stream and debug endpoints. |
