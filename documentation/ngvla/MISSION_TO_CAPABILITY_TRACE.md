...
| ----------------------------- | ----------------------------------------------------- | -------------------------------------------------------------------- | ---------------------- | ----------------------------------------------------------------------------------------------------------------- |
| Observatory continuity        | Health visibility and incident context in one console | Angular routes (`Telemetry`, `Topology`, `Diagnostics`, `Dashboard`) | implemented (baseline) | `apps/frontend/src/app/app.routes.ts`, `docuentation/frontend/FRONTEND_UI.md`, messaging status endpoints added   |
