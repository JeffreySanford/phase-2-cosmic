...
| [`active-dataset-selection.mmd`](./active-dataset-selection.mmd)               | Registry-driven include/exclude flow for active Lakehouse development datasets                                                                      | [`ACTIVE_DATASET_SELECTION_PLAN.md`](../docs/ACTIVE_DATASET_SELECTION_PLAN.md) |
| [`public-dataset-onboarding.mmd`](./public-dataset-onboarding.mmd)             | Future public-source onboarding workflow from discovery through activation decision                                                                 | [`ACTIVE_DATASET_SELECTION_PLAN.md`](../docs/ACTIVE_DATASET_SELECTION_PLAN.md) |
| [`pr41-mvp-lakehouse.mmd`](./pr41-mvp-lakehouse.mmd)                           | PR41 MVP local Bronze/Silver/Gold artifact flow and verifier                                                                                        | [`PR41_MVP_LAKEHOUSE.md`](../docs/PR41_MVP_LAKEHOUSE.md)                       |
| [`pr42-databricks-sprint-plan.mmd`](./pr42-databricks-sprint-plan.mmd)         | PR42 Databricks production-runtime target topology and evidence path                                                                                | [`PR42_DATABRICKS_SPRINT_PLAN.md`](../docs/PR42_DATABRICKS_SPRINT_PLAN.md)     |
