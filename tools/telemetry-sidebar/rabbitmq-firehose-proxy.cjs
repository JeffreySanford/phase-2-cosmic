...
// This script is written in CommonJS so it can be executed directly with Node
// even when the surrounding repo uses ESM.
...
async function start() {
  ...
  // The RabbitMQ firehose exchange is typically durable; avoid precondition failures by matching the existing settings.
