...
The container now runs a startup diagnostics script that collects passive system specs and writes them to `logs/system-specs.txt` and to container stdout. By default active benchmarks are disabled. For full guidance see `docuentation/frontend/features/DIAGNOSTICS.md`.
...
- `docuentation/frontend/features/DIAGNOSTICS.md`
- `docuentation/frontend/features/TELEMETRY.md`
