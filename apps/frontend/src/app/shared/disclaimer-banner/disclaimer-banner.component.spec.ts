...
describe('DisclaimerBannerComponent', () => {
  ...
  describe('type: modeling', () => {
    ...
    it('should apply modeling class', () => {
      ...
      expect(banner?.classList.contains('disclaimer-banner--modeling')).toBe(true);
    });
  ...
  describe('type: development', () => {
    ...
    it('should apply development class', () => {
      const compiled = fixture.nativeElement as HTMLElement;
      const banner = compiled.querySelector('.disclaimer-banner');
      expect(banner?.classList.contains('disclaimer-banner--development')).toBe(true);
    });
  });
  ...
  describe('type: simulation', () => {
    ...
    it('should apply simulation class', () => {
      const compiled = fixture.nativeElement as HTMLElement;
      const banner = compiled.querySelector('.disclaimer-banner');
      expect(banner?.classList.contains('disclaimer-banner--simulation')).toBe(true);
    });
  });
  ...
  describe('dismissible', () => {
    ...
    it('should show dismiss button when dismissible is true', () => {
      const compiled = fixture.nativeElement as HTMLElement;
      const dismissButton = compiled.querySelector('.disclaimer-banner__dismiss');
      expect(dismissButton).toBeTruthy();
    });

    it('should hide banner when dismiss button is clicked', () => {
      const compiled = fixture.nativeElement as HTMLElement;
      const dismissButton = compiled.querySelector('.disclaimer-banner__dismiss') as HTMLButtonElement;
