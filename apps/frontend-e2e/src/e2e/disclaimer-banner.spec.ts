...
test.describe('Disclaimer Banner', () => {
  ...
  test('should display disclaimer banner on Datasets page', async ({ page }) => {
  ...
  test('should display disclaimer banner on Diagnostics page', async ({ page }) => {
  ...
  test('should show dismiss button on dismissible banners', async ({ page }) => {
    await page.goto(`${baseUrl}/jobs?e2e=1`);
  ...
  test('should dismiss banner when dismiss button is clicked', async ({ page }) => {
    await page.goto(`${baseUrl}/jobs?e2e=1`);
