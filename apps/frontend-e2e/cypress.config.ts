...
export default defineConfig({
  e2e: {
    ...nxE2EPreset(__filename, {
      ...
      webServerCommands: {
        default:
          'pnpm exec concurrently --kill-others-on-fail --success first "cross-env FRONTEND_PORT=4000 DEV_SERVER_ORIGIN=http://127.0.0.1:4200 DISABLE_NEST_VITE_DEV_SERVER=true DISABLE_REDIS_CLIENT=true USE_EMBEDDED_E2E_BACKEND=true pnpm run serve:ssr" "pnpm exec nx run frontend:serve --host=127.0.0.1"',
