...
- [../TODO.md](/docuentation/planning/TODO.md) for execution
...
- clear target audience (or link to [AUDIENCE_GUIDE.md](/docuentation/overview/AUDIENCE_GUIDE.md) read path)

Related enforcement:
- see [ALIGNMENT.md](/docuentation/overview/ALIGNMENT.md)
