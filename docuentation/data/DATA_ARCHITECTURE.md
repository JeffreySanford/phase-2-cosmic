...
```json
{
  ...
  "parameters":     {},
  "checksum":       "sha256:<hex>",
  "auditEvents":    [{ "at": "ISO-8601", "actor": "principal", "action": "SUBMITTED|TRANSITIONED|DELETED" }]
}
```
...
```json
{ "at": "2026-03-03T18:30:00Z", "actor": "operator@nrao.edu", "action": "JOB_SUBMITTED",
  "subject": "job-uuid", "workflow": "ingest", "ip": "10.0.1.5" }
```
