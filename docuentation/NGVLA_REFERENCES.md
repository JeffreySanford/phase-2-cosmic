...
**Cosmic Horizon Alignment**: See [MISSION_TO_CAPABILITY_TRACE.md](MISSION_TO_CAPABILITY_TRACE.md) for how our platform provenance model aligns with ngVLA operational reproducibility goals.
...
**Implementation**: See [schemas/fixtures/ngvla/](../schemas/fixtures/ngvla/) for example workflow payloads and dataset manifests.
...
3. Pass regression tests for NGVLA fact drift (see [TESTING_REQUIREMENTS.md](TESTING_REQUIREMENTS.md))
