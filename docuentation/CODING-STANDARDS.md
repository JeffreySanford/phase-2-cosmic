...
See the canonical developer run and environment docs for workflow details: [GETTING_STARTED.md](GETTING_STARTED.md) and [ENVIRONMENT.md](ENVIRONMENT.md).
...
## If implementing v1.1/v2 work (comments, [Mode B](../architecture/core/MODE-B.md), FITS proxy), gate with explicit roadmap updates first
