...
1. Build a contract test harness that simulates ingest velocity and validates Governance API interactions.
1. Prototype a compute-near-data pipeline at TACC or an equivalent national HPC center to validate in-place processing patterns.
1. Define retention and economic models for warm vs cold data across realistic mission timelines.
